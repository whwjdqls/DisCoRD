...
class HumanVQVAE(nn.Module):
    def __init__(self,
        ...
        self.vqvae = VQVAE_251(output_dim, nb_code, code_dim, output_emb_width, down_t, stride_t, width, depth, dilation_growth_rate, activation=activation, quantizer=quantizer,norm=norm)
    ...
    def get_qauntized(self,x):
        return self.vqvae.get_qauntized(x) # (Bs, c, T/q)
